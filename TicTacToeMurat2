        ...
        while (true) {
            ...
            if (user(userChanger).equals("player")) { // if the move order is on the player
                ...
                while (true) { // here we make a loop that will continue until the game is over
                    ...
                    // Here we convert the numbers entered by the player to integer.
                    // because the selected numbers will be checked in integer format
                    ...
                    if ((numbers.contains(position)) && !selectedPosition.contains(pos)) {


                        playerPositions.add(pos);// // The number selected by the player is added to the list.
                        // with this list we will check if the player can win or not

                        selectedPosition.add(pos);// with this list we will check if the same number has been selected before.
                ...
                while (true) {
                    ...
                    String cpuNumber2 = userCPU();//
                    int cpuNumber = Integer.valueOf(cpuNumber2);//
                    ...
                    if (!selectedPosition.contains(cpuNumber)) {
                        ...
                        izolated(gameBoard, cpuNumber2, user(userChanger));
